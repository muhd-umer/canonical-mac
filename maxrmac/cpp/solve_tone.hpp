/**
 * @file solve_tone.hpp
 * @brief Per-tone L-BFGS optimization for maxRMAC MIMO
 *
 ...
 * @param theta Per-user rate weights [U]
 * @param w Per-user energy weights (Lagrange multipliers) [U]
 ...
 * @param state_in Optional warm-start state
